...
import { dataService } from './src/lib/db-adapter.ts';
...
// Update WhatsApp manual send status (confirmation, reminder_7 .. reminder_0)
...
// Delete Registration (Soft Delete to Bin or Permanent)
...
// Restore Registration from Deleted Bin
...
app.get('/api/admin/settings/templates', verifyAdmin, async (req, res) => {
  try {
...
// Vite middleware for local development and static serving for production
